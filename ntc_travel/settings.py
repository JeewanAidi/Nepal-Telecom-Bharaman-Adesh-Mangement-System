...
SECRET_KEY = 'django-insecure-ntc-mahendranagar-travel-management-2024-secret-key'
...
INSTALLED_APPS = [
    "nepal-telecom-bharaman-adesh-mangement.onrender.com"
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'travel_management' / 'static']
